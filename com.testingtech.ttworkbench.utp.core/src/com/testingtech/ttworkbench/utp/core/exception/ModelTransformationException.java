...
public class ModelTransformationException extends Exception{
   ...
   * 
   */
  private static final long serialVersionUID = 4224519637280405605L;

  public ModelTransformationException(NamedElement e, String str) {

    super(Messages.ModelTransformationException_Msg0
        + e.getQualifiedName() + "':\n" + str); //$NON-NLS-1$
  }
