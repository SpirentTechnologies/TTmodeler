...
/**
 * A Method constraint is a condition imposed on a Method. It is accessed through 
 * either the Method PreConditions or Method PostConditions collection.
 */
public class MethodConstraint extends AbstractEADispatch {

  public MethodConstraint(IDispatch disp) {

    super(disp);
    logger = Logger.getLogger(MethodConstraint.class);
