 ...
 */
public class AttributeConstraint extends AbstractEADispatch {

  public AttributeConstraint(IDispatch disp) {

    super(disp);
    logger = Logger.getLogger(AttributeConstraint.class);
  ...
  /**
   * Read/Write. ID of Attribute this constraint applies to.
   */
  ...
  public void setAttributeID(Double id) {

    try {
      this.put("AttributeID", id);
    }
    catch (JComException e) {
      logger.warn(e.getMessage());
    }
