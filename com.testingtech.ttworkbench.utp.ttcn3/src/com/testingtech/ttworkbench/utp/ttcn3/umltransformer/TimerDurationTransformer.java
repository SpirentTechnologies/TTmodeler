...
public class TimerDurationTransformer implements UML2TTCN3Transformer<ValueSpecification, FloatValue> {


  public FloatValue transform(ValueSpecification durationValue) {         
    
    Value durationValueTTCN3 = (Value) new ValueSpecificationTransformer().transform(durationValue);
    return (FloatValue) durationValueTTCN3;
  }
}
