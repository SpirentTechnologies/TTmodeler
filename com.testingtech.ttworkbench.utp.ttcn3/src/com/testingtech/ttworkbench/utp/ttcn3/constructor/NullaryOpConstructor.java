...
public class NullaryOpConstructor {

  public NullaryOperation construct(String opName) {

    NullaryOperation nullaryOp = DeclarationGenerator.generateNullaryOperation();
    Name nullaryOpName = new NameConstructor().construct(opName);
    nullaryOp.setTheName(nullaryOpName);
    return nullaryOp;
  }
