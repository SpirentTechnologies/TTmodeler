...
public class AltStatementConstructor {

  public AltStatement construct(List<AltAlternative> alternatives) {

    AltStatement altStatement = DeclarationGenerator.generateAltStatement();
    ECollections.setEList(altStatement.getTheAlternatives(), alternatives);
    return altStatement;
  }
