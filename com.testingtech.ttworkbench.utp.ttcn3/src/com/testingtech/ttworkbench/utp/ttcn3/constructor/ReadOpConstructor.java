...
public class ReadOpConstructor {

  public Read construct(Expression expression) {

    Read readOp = DeclarationGenerator.generateReadOperation();
    readOp.setTheOperand(expression);
