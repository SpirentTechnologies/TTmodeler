...
public class ExecuteStatementConstructor {

  public ExecuteStatement construct() {
    ExecuteStatement executeStatement = DeclarationGenerator.generateExecuteStatement();    
