...
public class StartStatementConstructor {

  /**
   * @param elementData
   * @return
   */
  public StartStatement construct(Expression timer, FloatValue duration) {

    StartStatement startStatement = DeclarationGenerator.generateStartStatement();
    startStatement.setTheOperand(timer);    
    if (duration != null) {
      startStatement.setTheWith(duration);
    }
