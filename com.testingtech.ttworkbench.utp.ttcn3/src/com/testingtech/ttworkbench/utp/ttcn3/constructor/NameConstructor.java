...
public class NameConstructor{
  ...
  public Name construct(NamedElement namedElement) {
    String nameAsString = namedElement.getName();
    return construct(nameAsString);
  }
  
  public Name construct(String nameAsString) {
    return DeclarationGenerator.generateName(nameAsString);
  }
