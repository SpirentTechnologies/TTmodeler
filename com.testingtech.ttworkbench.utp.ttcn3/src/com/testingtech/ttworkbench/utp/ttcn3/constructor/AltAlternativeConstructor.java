...
public class AltAlternativeConstructor {

  public AltAlternative construct (Expression guard, Expression event, Statement body) {
    AltAlternative alt = DeclarationGenerator.generateAltAlternative();
