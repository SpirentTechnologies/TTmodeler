 ...
 *
 */
public class ActionExtractor extends ElementExtractor {

  private EList<InputPin> inputPins;
  private EList<OutputPin> outputPins;
  
  public ActionExtractor(Action action) {
    ...
    public InputPin getInputPinByKeyword(String pinKeyword) {      
      return UMLExtractionUtil.getElementbyKeyword(pinKeyword, inputPins);
    }
    
    public OutputPin getOutputPinByKeyword(String pinKeyword) {      
      return UMLExtractionUtil.getElementbyKeyword(pinKeyword, outputPins);
    }   
